        ...
        <aside className={`resume-sidebar ${isVisible ? 'fade-in' : ''}`}>
          <div className="sidebar-content">
            ...
            <div className="contact-info">
              ...
              <div className="contact-group">
                <a href={`mailto:${resumeData.contactInfo.email}`} className="contact-link">
          ...
          <section className="resume-content-section">
            ...
            <div className="experience-list">
              {resumeData.workExperience.map((entry, index) => (
                <article
                  key={index}
                  className={`experience-entry ${isVisible ? 'fade-in-up' : ''}`}
                >
            ...
            <div className="experience-list">
              {resumeData.education.map((entry, index) => (
                ...
                >
                  ...
                  {entry.details && <p className="entry-description">{entry.details}</p>}
                </article>
              ))}
            </div>
          </section>
